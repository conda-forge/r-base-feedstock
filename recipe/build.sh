...
Linux() {
    ...
    # Add symlink for Rblas and Rlapack for backward compatibility
    # TODO: Remove in next version
    pushd ${PREFIX}/lib/R/lib
      ln -s ${PREFIX}/lib/libblas.so.3 libRblas.so
      ln -s ${PREFIX}/lib/liblapack.so.3 libRlapack.so
    popd
...
Darwin() {
    ...
    # TODO: Remove in next version
    pushd ${PREFIX}/lib/R/lib
      ln -s ${PREFIX}/lib/libblas.3.dylib libRblas.dylib
      ln -s ${PREFIX}/lib/liblapack.3.dylib libRlapack.dylib
    popd
