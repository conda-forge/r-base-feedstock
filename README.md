...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-base-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-base-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add cross-r-base r-base
# for installing globally
pixi global install cross-r-base r-base
```
...
It is possible to list all of the versions of `cross-r-base` available on your platform:
...
```
pixi search cross-r-base --channel conda-forge
```
